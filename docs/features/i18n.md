...
> for the foundation contract. This page documents only how Filinq
...
curl -X PATCH \
     ...
     'https://example.tld/index.php/apps/filinq/api/objects/dossier/abc'
```
...
* `tests/unit/Middleware/LanguageNegotiationMiddlewareTest.php` —
  10 tests covering the filinq-side bridge
