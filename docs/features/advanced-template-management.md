...
Filinq extends basic template CRUD with version history, live preview, template duplication,
...
```
GET    /apps/filinq/api/templates
POST   /apps/filinq/api/templates
GET    /apps/filinq/api/templates/{id}
PUT    /apps/filinq/api/templates/{id}
DELETE /apps/filinq/api/templates/{id}
```
...
| `namespace`    | string  | App namespace that owns the template (e.g. `filinq`)  |
...
```
GET  /apps/filinq/api/templates/{id}/versions
POST /apps/filinq/api/templates/{id}/versions/{versionId}/restore
GET  /apps/filinq/api/templates/{id}/versions/diff
```
...
```
GET /apps/filinq/api/templates/{id}/versions/diff?from={versionId}&to={versionId}
```
...
```
POST /apps/filinq/api/templates/preview
POST /apps/filinq/api/templates/{id}/preview
```
...
```
POST /apps/filinq/api/templates/{id}/duplicate
```
...
```
POST   /apps/filinq/api/templates/{id}/lock
DELETE /apps/filinq/api/templates/{id}/lock
```
...
settings configured in Filinq admin:
