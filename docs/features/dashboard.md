...
- **Consent Stats Cards**: Total, Pending, Approved, and Objected counts with color coding
- **Recent Consent Activity**: List of the 10 most recent consent records with status badges
- **Quick Anonymization**: Embedded anonymization widget with drag-and-drop upload
- **Nextcloud Widgets**: AnonymizationWidget and FileEntitiesWidget for the NC Dashboard
