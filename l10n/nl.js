OC.L10N.register(
    ...
    "Missing text layer" : "Tekstlaag ontbreekt",
    "Incomplete metadata" : "Onvolledige metadata",
    "The file format {mime} is not allowed for this document type." : "Het bestandsformaat {mime} is niet toegestaan voor dit documenttype.",
    "The file extension does not match its detected content type." : "De bestandsextensie komt niet overeen met het gedetecteerde inhoudstype.",
    "The file could not be read or parsed." : "Het bestand kon niet worden gelezen of verwerkt.",
    "The PDF is encrypted or password-protected and cannot be anonymised." : "De PDF is versleuteld of met een wachtwoord beveiligd en kan niet worden geanonimiseerd.",
    "The document has little or no extractable text; OCR may be required." : "Het document bevat weinig of geen uitleesbare tekst; OCR is mogelijk vereist.",
    "Required metadata field \"{field}\" is missing." : "Verplicht metadataveld \"{field}\" ontbreekt.",
    "Compare…" : "Vergelijken…",
