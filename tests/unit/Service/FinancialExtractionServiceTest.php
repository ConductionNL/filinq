...
TEXT;
	...
	public function testAddCorrectionStoredAdditively(): void {
		$existing = new class([ 'id' => 'extraction-3', 'fields' => ['supplierName' => null, 'totalIncl' => 18.50], 'fieldConfidence' => ['totalIncl' => 0.71], 'overallConfidence' => 0.71, 'corrections' => [], ]) implements \JsonSerializable {
			public function __construct(
				private array $data,
			) {
			}
