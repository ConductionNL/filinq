...
/**
 * Scan src/ for t('<app>', '...') and n('<app>', '...', ...) calls and return
 * the set of literal keys referenced. For n() the registered key is the
 * singular (first string arg), which is exactly what this captures. Mirrors the
 * extractor used by check-l10n.js / clean-l10n.js so "is this key still in
 * use?" answers stay consistent across all three tools.
 *
...
/**
 * Find the file:line of every static t('<app>', '<key>') / n('<app>', '<key>',
 * ...) reference. Used by l10n-ai.js rm to explain *why* a removal is refused.
 */
