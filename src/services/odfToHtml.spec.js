...
const content = (body) => '<?xml version="1.0" encoding="UTF-8"?>'
...
describe('odfXmlToHtml', () => {
	...
	it('never emits executable markup from document text (XSS-safe)', () => {
		const html = odfXmlToHtml(content('<text:p>&lt;script&gt;alert(1)&lt;/script&gt;</text:p>'))
