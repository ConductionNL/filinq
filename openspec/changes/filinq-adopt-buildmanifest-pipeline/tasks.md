# Tasks: filinq-adopt-buildmanifest-pipeline

All tasks are `[filinq]`. Estimates: S = half-day, M = 1–2 days, L = 3+ days.

## [filinq] ADR-037 fragment-pipeline prerequisite
...
## [filinq] ADR-044 buildManifest adoption
...
## [filinq] Dead navigation code removal
