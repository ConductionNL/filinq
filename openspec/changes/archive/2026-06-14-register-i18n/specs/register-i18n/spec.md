...
- **OpenRegister register-i18n spec**: Foundation for multi-language register objects (must be implemented first)
- **BCP 47 language tags**: Standard language codes (nl, en, de, fr, etc.)
- **Nextcloud l10n framework**: For UI string translations (separate from register content)

### Current Implementation Status
- **Not implemented**: No multi-language content support exists. All content is single-language (typically Dutch).
- **Depends on**: OpenRegister register-i18n being implemented first
- **App-level work needed**: Frontend language selector, fallback display, API Accept-Language routing

### Standards & References
- **BCP 47**: Language tags (nl, en, de, fr, etc.)
- **W3C Internationalization**: Best practices for multilingual content
- **WCAG 2.1 SC 3.1.1**: Language of Page
- **WCAG 2.1 SC 3.1.2**: Language of Parts
- **Nextcloud l10n**: UI string translation framework
