# Proposal: docudesk-policy-controller-test-coverage
...
policy surface DocuDesk enforces fleet-wide.

**Confirmed via repo-wide search: zero test files exist for either class.**
`tests/unit/Controller/` has test files for 12 of DocuDesk's 20 other
