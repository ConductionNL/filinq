# Design: docudesk-adopt-buildmanifest-pipeline

## Context

DocuDesk adopted the app-manifest pattern (ADR-024) early, before
...
- **Leave the bespoke pipeline in place.** Rejected — it is the literal
  duplication ADR-044 was written to eliminate, and DocuDesk inherits none of
