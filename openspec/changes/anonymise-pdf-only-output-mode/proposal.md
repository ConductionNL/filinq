...
- **Code (docudesk):**
  ...
  - `lib/Service/SettingsService.php` — tenant default `docudesk.anonymisation.default_output_format` flips from `pdf` to `pdf-only`.
