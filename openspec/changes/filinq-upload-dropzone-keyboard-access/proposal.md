# Proposal: filinq-upload-dropzone-keyboard-access

kind: code

## Why

Four Filinq views implement a near-identical drag-and-drop file-upload
...
- `src/views/anonymization/AnonymizationWidget.vue:9-33` — the trigger is a
  ...
  wrapping a decorative `<span class="fake-button">{{ t('filinq', '+
...
"WCAG AA mandatory: keyboard-navigable" rule for all Filinq UI.
