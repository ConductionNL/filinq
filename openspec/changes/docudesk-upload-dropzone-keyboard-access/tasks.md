# Tasks: docudesk-upload-dropzone-keyboard-access

All tasks are `[docudesk]`. Estimates: S = half-day.

## [docudesk] AnonymizationWidget.vue

### A-1. Add a keyboard-operable trigger (S)

- [ ] A-1.1 Replace `<span class="fake-button">{{ t('docudesk', '+ Select
...
## [docudesk] AnonymizationDashboardWidget.vue
