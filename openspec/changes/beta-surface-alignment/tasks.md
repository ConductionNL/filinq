...
- [x] 7. `docudesk/docs/intro.md`: remove SharePoint/Office365/WCAG claims,
      fix Word/Excel→PDF/ODF/HTML, fix install category, fix Presidio framing.
- [x] 8. `docudesk/docs/features/external-integration.md`: replace fabricated
