...
class TemplateService
{
     ...
     *
     * Supports namespace, category, and tags filter parameters in addition
     * to the standard _search, _limit, _offset parameters.
     *
     ...
     *
     * @throws Exception If the original template is not found or duplication fails
     *
     * @SuppressWarnings(PHPMD.ShortVariable)
     */
    ...
    public function releaseLock(string $id, string $userId): array
    {
        ...
        // Only the lock holder can release the lock (or if lock is expired).
