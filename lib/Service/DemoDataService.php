<?php
/**
 * Filinq DemoDataService.
 *
 * Imports `lib/Settings/filinq_mock_register.json` — a `type: mock` descriptor generated from this
...
class DemoDataService {
	 ...
	 * @var string
	 */
	private const DESCRIPTOR = '/lib/Settings/filinq_mock_register.json';
