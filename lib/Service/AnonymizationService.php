...
class AnonymizationService
{
     ...
     *
     * The response also includes a `customDictionaryWarning` field: null when
     * the custom-dictionary matching pass (organisation-managed term lists,
     * `CUSTOM_DICTIONARY` entities) ran without error, or a human-readable
     * warning string when it failed. OpenRegister's own detections are always
