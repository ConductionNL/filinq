 ...
 * plus version history, preview, duplication, and locking endpoints.
...
class TemplatesController extends Controller
{
     ...
     *
     * Supports query parameters: namespace, category, tags, _search, _limit, _offset
     *
     ...
     *
     * @param string $id The template UUID (for route context)
     *
    ...
    public function preview(): JSONResponse
    {
        try {
            ...
            $html = $this->previewService->preview(
                content: $content,
                data: $context
            );
    ...
    public function previewTemplate(string $id): JSONResponse
    {
        try {
            ...
            $html = $this->previewService->previewTemplate(
                templateId: $id,
                data: $context
            );
     ...
     * @param string $id The template UUID
     *
     * @return JSONResponse JSON response with the locked template object
     *
     * @NoAdminRequired
     * @NoCSRFRequired
     *
    ...
    public function lock(string $id): JSONResponse
    {
        try {
            ...
            $result = $this->templateService->acquireLock(
                id: $id,
                userId: $userId
            );
     ...
     * @param string $id The template UUID
     *
     * @return JSONResponse JSON response with the unlocked template object
     *
     * @NoAdminRequired
     * @NoCSRFRequired
     *
    ...
    public function unlock(string $id): JSONResponse
    {
        try {
            ...
            $result = $this->templateService->releaseLock(
                id: $id,
                userId: $userId
            );
